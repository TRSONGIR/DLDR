...
<div class="box box-primary">
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <?=
                $this->Form->input('Options.' . $settings['zarinpal_withdrawal_enable']['id'] . '.value', [
                    'label' => false,
                    'options' => [
                        0 => __('No'),
                        1 => __('Yes')
                    ],
                    'value' => $settings['zarinpal_withdrawal_enable']['value'],
                    'class' => 'form-control'
                ]);
                ?>
            </div>
        ...
        <div class="row">
            <div class="col-sm-2"><?= __('ZarinPal Minimum Withdrawal Amount') ?></div>
            <div class="col-sm-10">
                <?=
                $this->Form->input('Options.' . $settings['zarinpal_withdrawal_amount']['id'] . '.value', [
                    'label' => false,
                    'class' => 'form-control',
                    'type' => 'text',
                    'value' => $settings['zarinpal_withdrawal_amount']['value']
                ]);
                ?>
            </div>
        </div>
